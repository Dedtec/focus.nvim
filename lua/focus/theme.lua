...
theme.set_highlights = function()
  ...
  hl(0, "CursorLine", { fg = 'NONE', bg = c.bg_hi2 })
  hl(0, "CursorColumn", { fg = 'NONE', bg = c.bg_hi2 })
  ...
  hl(0, "DiffText", { fg = 'NONE', bg = c.diff_text }) -- TODO: fix
  ...
  hl(0, "MatchParen", { bg = c.green, fg = c.black, bold=true, })
  ...
  hl(0, "Directory", { bg = 'NONE', fg = c.fg2 })
  ...
  hl(0, "Substitute", { fg = c.fg, bg = c.red })
  ...
  hl(0, "Identifier", { bg = 'NONE', fg = c.fg }) -- alternative?
  hl(0, "String", { bg = c.green, fg = c.fg })
  hl(0, "Character", { bg = c.green, fg = c.fg })
  hl(0, "Number", { bg = c.orange, fg = c.fg })
  hl(0, "Float", { bg = c.orange, fg = c.fg })
  hl(0, "Boolean", { bg = c.orange, fg = c.fg })
  hl(0, "Constant", { bg = c.orange, fg = c.fg })
  hl(0, "Function", { bg = c.blue, fg = c.fg })
  hl(0, "Statement", { bg = c.magenta, fg = c.fg })
  hl(0, "Conditional", { bg = c.magenta, fg = c.fg })
  hl(0, "Repeat", { bg = c.magenta, fg = c.fg })
  hl(0, "Label", { bg = c.magenta, fg = c.fg })
  hl(0, "Operator", { fg = c.fg, bg = 'NONE' })
  hl(0, "Keyword", { bg = c.purple, fg = c.fg })
  hl(0, "Exception", { bg = c.red, fg = c.fg })
  hl(0, "PreProc", { bg = c.purple, fg = c.fg })
  hl(0, "Define", { bg = c.purple, fg = c.fg })
  hl(0, "Macro", { bg = c.purple, fg = c.fg })
  hl(0, "Include", { bg = 'NONE', fg = c.fg, italic=true })
  ...
  hl(0, "Special", { bg = 'NONE', fg = c.fg2 })
  hl(0, "SpecialChar", { bg = 'NONE', fg = c.fg2 })
  hl(0, "Delimiter", { bg = 'NONE', fg = c.fg2 })
  hl(0, "SpecialComment", { bg = 'NONE', fg = c.fg2 })
  hl(0, "Debug", { bg = 'NONE', fg = c.fg2 })

  hl(0, "Tag", { bg = c.blue, fg = c.fg })
  hl(0, "Title", { bg = c.blue, fg = c.fg, bold=true, })
  hl(0, "Todo", { fg = c.fg, bg = 'NONE', bold=true, })
  hl(0, "Error", { bg = c.error, fg = c.fg, bold=true, })
  ...
  hl(0, "@parameter", { bg = c.yellow, fg = c.fg })
  ...
  hl(0, "@field", { bg = 'NONE', fg = c.fg })
  hl(0, "@property", { bg = 'NONE', fg = c.fg })
  hl(0, "@variable", { link = 'Variable' })
  hl(0, "@variable.builtin", { bg = 'NONE', fg = c.fg, italic=true })
  ...
  -- markdown
  hl(0, "markdownBlockquote", { bg = c.orange, fg = c.fg })
  hl(0, "markdownCode", { bg = c.teal, fg = c.fg })
  hl(0, "markdownCodeBlock", { bg = c.teal, fg = c.fg })
  hl(0, "markdownCodeDelimiter", { bg = c.teal, fg = c.fg })
  ...
  hl(0, "markdownHeadingDelimiter", { bg = c.orange, fg = c.fg, bold=true, })
  ...
  hl(0, "markdownBoldItalic", { bg = c.yellow, fg = c.fg, bold=true, italic=true, })
  hl(0, "markdownListMarker", { bg = c.orange, fg = c.fg, bold=true, })
  hl(0, "markdownOrderedListMarker", { bg = c.orange, fg = c.fg, bold=true, })
  hl(0, "markdownRule", { link = 'PreProc' })
  hl(0, "markdownUrl", { bg = c.cyan, fg = c.fg, underline=true, })
  hl(0, "markdownLinkText", { bg = c.cyan, fg = c.fg, underline=true, })
  hl(0, "markdownFootnote", { link = 'Typedef' })
  hl(0, "markdownFootnoteDefinition", { link = 'Typedef' })
  hl(0, "markdownEscape", { link = 'Special' })
  hl(0, "@text.literal.markdown_inline", { fg = c.fg, bg = c.blue })
  hl(0, "@punctuation.special.markdown", { bg = c.orange, fg = c.fg, bold=true, })

  -- Whichkey
  hl(0, "WhichKey", { fg = c.fg, bg = 'NONE' })
  hl(0, "WhichKeySeperator", { link = 'Comment' })
  hl(0, "WhichKeyGroup", { bg = 'NONE', fg = c.fg })
  hl(0, "WhichKeyDesc", { bg = 'NONE', fg = c.fg })
  ...
  hl(0, "DiagnosticHint", { bg = c.teal, fg = c.fg })
  hl(0, "DiagnosticInfo", { bg = c.teal, fg = c.fg })
  hl(0, "DiagnosticWarn", { bg = c.yellow, fg = c.fg })
  hl(0, "DiagnosticError", { bg = c.error, fg = c.fg })
  hl(0, "DiagnosticOther", { bg = c.purple, fg = c.fg })
  ...
  hl(0, "DiagnosticVirtualTextHint", { bg = c.teal, fg = c.fg })
  hl(0, "DiagnosticVirtualTextInfo", { bg = c.teal, fg = c.fg })
  hl(0, "DiagnosticVirtualTextWarn", { bg = c.yellow, fg = c.fg })
  hl(0, "DiagnosticVirtualTextError", { bg = c.error, fg = c.fg })
  ...
  hl(0, "NvimTreeLspDiagnosticsError", { fg = c.fg, bg = 'NONE' })
  hl(0, "NvimTreeLspDiagnosticsWarning", { fg = c.fg, bg = 'NONE' })
  hl(0, "NvimTreeLspDiagnosticsInformation", { fg = c.fg, bg = 'NONE' })
  hl(0, "NvimTreeLspDiagnosticsInfo", { fg = c.fg, bg = 'NONE' })
  hl(0, "NvimTreeLspDiagnosticsHint", { fg = c.fg, bg = 'NONE' })
  ...
  hl(0, "TelescopeSelectionCaret", { fg = c.fg , bg = c.bg_visual })
  hl(0, "TelescopeMatching", { fg = c.fg, bg = c.red, bold=true, italic=true, })
  ...
  hl(0, "TelescopePreviewHyphen", { bg = c.red, fg = c.fg })

  -- NvimTree
  hl(0, "NvimTreeFolderIcon", { link = 'Directory' })
  hl(0, "NvimTreeIndentMarker", { fg = c.comment, bg = 'NONE' })
  ...
  hl(0, "NvimTreeFolderName", { bg = 'NONE', fg = c.fg })
  hl(0, "NvimTreeOpenedFolderName", { bg = 'NONE', fg = c.fg })
  hl(0, "NvimTreeEmptyFolderName", { link = 'Comment' })
  hl(0, "NvimTreeOpenedFile", { fg = c.fg, bg = c.bg_highlight })
  hl(0, "NvimTreeGitIgnored", { link = 'Comment' })
  hl(0, "NvimTreeImageFile", { fg = c.fg_dark, bg = 'NONE' })
  hl(0, "NvimTreeSpecialFile", { bg = c.purple, fg = c.fg_dark })
  hl(0, "NvimTreeEndOfBuffer", { fg = c.bg_dark, bg = 'NONE' })
  hl(0, "NvimTreeCursorLine", { link = 'CursorLine' })
  hl(0, "NvimTreeGitStaged", { bg = c.gitsigns_add, fg = c.fg_dark })
  hl(0, "NvimTreeGitNew", { bg = c.gitsigns_add, fg = c.fg_dark })
  hl(0, "NvimTreeGitRenamed", { bg = c.gitsigns_add, fg = c.fg_dark })
  hl(0, "NvimTreeGitDeleted", { bg = c.gitsigns_delete, fg = c.fg_dark })
  hl(0, "NvimTreeGitMerge", { bg = c.gitsigns_change, fg = c.fg_dark })
  hl(0, "NvimTreeGitDirty", { bg = c.gitsigns_change, fg = c.fg_dark })
